 ...
 */
package com.neocop.neomcPlugin.Core;

import com.neocop.neomcPlugin.commands.CmdPort;
import com.neocop.neomcPlugin.commands.CmdRpg;
import com.neocop.neomcPlugin.commands.CmdRpgDetective;
import com.neocop.neomcPlugin.commands.CmdTrole;
...
public class Plugin extends JavaPlugin {
    ...
    public void onEnable() {
        System.out.println("----------Roleplay plugin starts!----------");
    ...
    public void reloadConfig() {
        ...
        CmdPort.savePorts();
        System.out.println("----------Roleplay plugin is disabled now!----------");
    }
