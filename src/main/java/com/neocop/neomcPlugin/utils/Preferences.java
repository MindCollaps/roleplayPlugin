...
public class Preferences {
    ...
    public static final String portToMuchChars = "§cBitte maximal 20 Zeichen für einen Port vergeben!";
    public static final String portMessageSucces =  "§aMessage zum Port hinzugefügt!";
    public static final String portDescriptionSucces = "§aBeschreibung zum Port hinzugefügt!"; 
    ...
    public static final String helpPortCommon = "/port create [name] - creates new global port\n"
                        ...
                        + "/port info [name] - shows the description from the port!\n"
                        + "/port list - shows global ports\n"
                        + "/port list private - shows private ports\n"
                        + "/port edit [name] share [player name] - add player to port\n"
                        + "/port edit [name] welcomeMsg §b[msg]§r - creats a welcomemessage to the port!\n"
                        + "/port edit [name] description §b[description]§r - adds a description to the port\n"
                        + "§bmsg ~ format.[color/formatting] - makes color or formatting in message!\n"
                        + "Example - format.blue Hello format.italic you format.reset format.green perosn!§r\n\n"
